...
class UserRoleHasModulesHasApiPermission(Base):
    __tablename__ = "user_role_has_modules_has_api_permission"
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            "module_id",
            "api_permission_id",
            name="uq_user_role_has_modules_has_api_perm",
        ),
    )
    ...
    apiPermissionId = Column("api_permission_id", Integer, ForeignKey("api_permissions.id"), nullable=False)
