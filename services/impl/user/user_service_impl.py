...
class UserServiceImpl(UserService):
    ...
    def create_or_update_user(
        ...
        logger.info(
            "UserServiceImpl => create_or_update_user function ended: %s", user_data
        )
    ...
    def get_user_by_id(self, db: Session, user_id: int) -> CommonResponseDTO:
        logger.info("UserServiceImpl => get_user_by_id function accessed: %s", user_id)
        ...
        logger.info("UserServiceImpl => get_user_by_id function ended: %s", user_id)
    ...
    def delete_user_by_id(self, db: Session, user_id: int) -> CommonResponseDTO:
        ...
        logger.info("UserServiceImpl => delete_user_by_id function ended: %s", user_id)
